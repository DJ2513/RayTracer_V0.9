 ...
 * @description Here we create the triangles
 */
public class Triangle implements IIntersectable {
    ...
    /**
     *
     * @param vertices Vertex of the triangle
     * @param normal Normals of the vertex
     */
    ...
    /**
     *
     * @param vertices list of the triangle vertex
     */
    ...
    /**
     *
     * @param normals List of the triangles Normals
     */
    ...
    /**
     *
     * @param normal1 Normal from Vertex 1
     * @param normal2 Normal from Vertex 2
     * @param normal3 Normal from Vertex 3
     */
     ...
     * @return The intersection between the traingle and a ray
     */
    @Override

 ...
 * @Description Here we construct the Directional Light
 */
public class DirectionalLight extends Light{
    ...
    /**
     *
     * @param direction Where the light is going
     * @param color Color of the light
     * @param intensity How intense the light is going to be
     */
    ...
    /**
     *
     * @param direction Sets the direction
     */
